...
export interface ApiGetTravelResponse { data: Travel | null }
export interface ApiCreateTravelResponse { travel: Travel }
export interface ApiUpdateTravelResponse { data: Travel }
export interface ApiDeleteTravelResponse { success: boolean; }